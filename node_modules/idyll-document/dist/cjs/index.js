...
var IdyllDocument = function (_React$Component) {
  ...
  IdyllDocument.prototype.componentDidMount = function componentDidMount() {
    ...
    if (!this.props.ast && this.props.markup) {
      (0, _idyllCompiler2.default)(this.props.markup).then(function (ast) {
        _this2.setState({ ast: ast, hash: hashCode(_this2.props.markup) });
      });
    }
  };
  ...
  IdyllDocument.prototype.componentWillReceiveProps = function componentWillReceiveProps(newProps) {
    ...
    if (hash !== this.state.hash) {
      ...
      (0, _idyllCompiler2.default)(newProps.markup).then(function (ast) {
        _this3.setState({ previousAST: ast, ast: ast, hash: hash });
  ...
  IdyllDocument.prototype.render = function render() {
    ...
    return _react2.default.createElement(_runtime2.default, _extends({}, this.props, {
      key: this.state.hash,
      context: function context(_context) {
        _this4.idyllContext = _context;_this4.props.context && _this4.props.context(_context);
      },
